...
const Field = ({
  ...
  onChange,
  autoFocus
}) => jsx(FieldContainer, null, jsx(FieldLabel, null, field.label), onChange ? jsx(TextInput, {
  autoFocus: autoFocus,
  ...
  return {
    ...
    filter: {
      ...
      graphql: ({
        ...
        return {
          [key]: ['in', 'not_in'].includes(type) ? valueWithoutWhitespace.split(',').map(i => parseFloat(i)) : parseFloat(valueWithoutWhitespace)
        };
      },
