import { Checkbox, Relationship, Text, Password, DateTimeUtc, Integer, Float, Decimal, Select, Virtual } from '@keystone-next/fields-legacy';
...
export { autoIncrement, checkbox, decimal, float, integer, mongoId, password, relationship, select, text, timestamp, virtual };
