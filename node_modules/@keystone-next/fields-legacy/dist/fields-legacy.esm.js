...
class PrismaSelectInterface extends CommonSelectInterface(PrismaFieldAdapter) {
  constructor() {
    ...
    this.isUnique = !!this.config.isUnique;
    this.isIndexed = !!this.config.isIndexed && !this.config.isUnique;
    this._prismaType = this.config.dataType === 'enum' && this.listAdapter.parentAdapter.provider !== 'sqlite' ? `${this.field.listKey}${inflection.classify(this.path)}Enum` : this.config.dataType === 'integer' ? 'Int' : 'String';
  }
...
export { index$a as Checkbox, index$9 as DateTimeUtc, index$8 as Decimal, index$7 as File, index$6 as Float, Field as Implementation, index$5 as Integer, index$4 as Password, index$3 as Relationship, index$2 as Select, index$1 as Text, index as Virtual };
